...
namespace EasyInput
{
    ...
    class Input
    {
        ...
        public static char ReadChar()
        {
            ...
            return readLine.Length switch
            {
                0 => throw new NullReferenceException("String must be one character long."),
                1 => Convert.ToChar(readLine),
                _ => throw new FormatException("String must be one character long.")
            };
        }
